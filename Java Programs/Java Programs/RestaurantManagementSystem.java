...
public class RestaurantManagementSystem {
    ...
    private static void viewMenu() {
        System.out.println("\n===== Menu =====");
        // Sort menu by price using bubble sort
        bubbleSortMenu();
        ...
        for (Order order : orders) {
            if (order.isPaid()) {
                ...
                System.out.println("Order ID: " + order.getOrderId() + 
                                 ", Customer: " + customers.get(order.getCustomerId()).getName() +
                                 ", Amount: " + orderTotal);
    ...
    private static void initializeData() {
        // Initialize menu
        menu.add(new MenuItem(1, "Pizza", 129));
        menu.add(new MenuItem(2, "Burger",199));
        menu.add(new MenuItem(3, "Pasta", 99));
        menu.add(new MenuItem(4, "Salad", 59));
        menu.add(new MenuItem(5, "Soda", 49));
